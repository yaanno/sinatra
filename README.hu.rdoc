...
A Sinatra keretrendszerben gyerekjáték a Rack middleware-ek behúzása az
...
Az +use+ metódus szemantikája megegyezik a 
...
használják). Hogy egy példát említsünk, az +use+ metódus egyaránt elfogad 
változókat és blokkokat is:
...
middleware, Rails meta, egyszerűbb kiszolgáló komponenssel bíró
...
A MyApp osztály immár önállóan, mondjuk Rack middleware-ként vagy
alkalmazásként, esetleg Rails metal-ként is tud működni. Közvetlenül
